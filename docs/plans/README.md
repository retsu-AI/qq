...
| [`guide-expansion.md`](./guide-expansion.md) | The eight guide pages the docs site dropped: agents, sessions, skills, environment, keybindings, server, enterprise, changelog; each guarded by docs-truth. Successor to onboarding UX (closed 2026-09-25; receipt in `progress/onboarding-ux.md`) |
...
| 1 | GE4 environment and GE5 keybindings references, then GE1–GE3 | [`guide-expansion.md`](./guide-expansion.md) | The site is live and generated from the guide; these are the pages users click through to and find missing. Small, independent, and each extends the docs-truth net |
