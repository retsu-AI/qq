...
| [`jev-usefulness.md`](./jev-usefulness.md) | agent on the Jev usefulness plan | JU0–JU8: consent/off correctness, approval task context, delegate-vs-human hold lifecycle, receipts, precision parsing, narrow pilot, qualification (ENG-938) |
