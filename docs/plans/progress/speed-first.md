...
| HC3 | `--output-schema`, repair turns, `final_output` | In progress | `feat/hc3-typed-final-output` (worktree `../qq-hc3`) | Started 2026-09-12 from `b0a18be`. Baseline `target/qq-perf/hc3-2026-09-12/`. Before H21.2. ADR-0014 reserved |
