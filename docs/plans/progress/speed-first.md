...
| H21.2 | Mechanical `sessions.rs` split | In review | `refactor/h21-2-sessions-split` | Ten concern modules + `tests/` tree; text-identical move, 1,401 tests unchanged, no ADR (D9/ADR-0012 already cover the design) |
