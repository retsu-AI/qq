...
| 0025 | SSE framing per chunk, parse once (D10) | speed-first H19 | Accepted (`perf/h19-sse-framing`, in review) |

Next free number: 0026. Reserve here before opening a PR that adds an ADR.
