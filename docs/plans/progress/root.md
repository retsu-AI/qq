...
| 0017 | Client UI stack: Rust/WASM, framework chosen by the W1 spike | multi-surface W1/U1 | Accepted 2026-09-24 (founder: Leptos 0.8): `docs/adr/0017-client-ui-stack.md`; spike in `benchmarks/wasm-ui-spike/`; framework-neutral remote contract |
