...
- [ADR-0042: two session switchers — the model, and how much Jev does](0042-session-model-and-jev-mode-switchers.md) — Proposed (integration plan § 2 item 9); `JevMode` ladder rows are a founder decision.
